// Stepper — animated step rail (21st.dev / shadcn-style): the step number
// morphs into a check when the step completes, separators light up behind the
// active step, and a spinner replaces the number while a step is loading.
//
// Adapted from the upstream source for this codebase: relative imports
// (tsconfig has no `@/` path mapping), and lucide-react's Check instead of
// @radix-ui/react-icons — same glyph, one fewer dependency.
